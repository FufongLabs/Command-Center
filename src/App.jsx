                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                        {PRESET_TAGS.slice(0,5).map(tag => (
                            <button 
                                ...
                                className={`text-[10px] px-2.5 py-1 rounded-full border font-medium transition-all active:scale-95 ${formData.tag === tag ? 'bg-blue-100 text-blue-700 border-blue-200' : 'bg-white text-slate-500 border-slate-200 hover:border-blue-300'}`}
                            >
                                {tag}
                            </button>
                        ))}
...
export default function TeamTaweeApp() {
  ...
  const [isSopOpen, setIsSopOpen] = useState(false); // Mobile SOP Accordion
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex justify-between items-center mb-6">
               <div>
                  <h2 className="text-2xl md:text-3xl font-black text-slate-800 tracking-tight">ภาพรวมสถานการณ์</h2>
                  <p className="text-slate-500 text-sm mt-1 font-medium">Overview & Statistics</p>
               </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-6">
                 ...
                 <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow flex-1 flex flex-col">
                    <div className="flex justify-between items-center mb-4"><p className="text-slate-500 text-xs font-bold uppercase">Strategy 4 แกน</p><button onClick={() => setActiveTab('strategy')} className="text-[10px] bg-slate-100 px-2 py-1 rounded text-slate-600 font-bold hover:bg-slate-200 transition">ดูทั้งหมด</button></div>
                        ...
                        {['solver', 'principles', 'defender', 'expert'].map((key) => {
                            ...
                            return (
                                <div key={key} className="bg-slate-50/80 p-3 rounded-xl border border-slate-100 flex flex-col justify-center items-center text-center cursor-pointer hover:border-blue-300 transition" onClick={() => setActiveTab('strategy')}>
                                    <span className="text-[10px] font-bold uppercase text-slate-400 mb-1">{key}</span>
                 ...
                 <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-center mb-4"><p className="text-slate-500 text-xs font-bold uppercase">Master Plan</p><button onClick={() => setActiveTab('masterplan')} className="text-[10px] bg-slate-100 px-2 py-1 rounded text-slate-600 font-bold hover:bg-slate-200 transition">ดูแผน</button></div>
                    <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col overflow-hidden">
                 <div className="p-6 border-b border-slate-100 bg-gradient-to-b from-white to-slate-50/50">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button onClick={() => setActiveTab('assets')} className="text-xs text-blue-600 hover:underline font-medium">จัดการ →</button>
                    </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 min-w-full md:min-w-[1200px] h-full">
                {[
                  ...
                  <div key={col.key} className={`w-full md:w-1/5 bg-${col.color}-50/50 rounded-2xl p-4 border border-${col.color}-100 flex flex-col shadow-sm`}>
                    <div className={`mb-4 pb-2 border-b border-${col.color}-200/50 flex justify-between items-center`}>
               ...
               <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fadeIn">
                  <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 transform transition-all relative">
                     ...
                     <div className="space-y-5">
                        ...
                        <div className="text-[10px] text-slate-400 bg-slate-50 p-3 rounded-xl border border-slate-100 flex justify-between">
                            <span>Created: {editingTask.createdBy}</span>
                            <span>Last Update: {editingTask.updatedBy || '-'}</span>
                        </div>
